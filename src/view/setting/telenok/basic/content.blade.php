    ...
    <div class="col-sm-9">
        ...
        <?php
            ...
            <div class="template-key-row-{{$uniqueId}}">
                ...
                {!! Form::select('value[telenok.view.theme][key][]', array_build(app('telenok.config.repository')->getViewTheme()->all(),
                    function($k, $v)
                    {
                        return [$v, $v];
        ...
        <template id="template-key-select-{{$uniqueId}}">
            <div class="template-key-row-{{$uniqueId}}">
                ...
                {!! Form::select('value[telenok.view.theme][key][]', app('telenok.config.repository')->getViewTheme()->all(), config('telenok.view.theme')) !!}
                {!! Form::select('value[telenok.view.theme][case][]', [
                        'default' => 'default',
                        'url-regex' => 'url-regex', 
                        'time-range' => 'time-range', 
