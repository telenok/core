...
return array(
    ...
    'error.class_model.store' => 'Dont know how to store php file for model\'s class ":class". Not standart class name. Create file first or class should begin with \\App\\Model',
