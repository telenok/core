...
class SeedWidgetOnPageTable extends \App\Vendor\Telenok\Core\Support\Migrations\Migration {
...
*/
        ...
        (new \App\Vendor\Telenok\Core\Model\Object\Type())->storeOrUpdate([
            'title'            => ['ru' => 'Виджет на странице', 'en' => 'Widget on page'],
            'title_list'       => ['ru' => 'Виджет на странице', 'en' => 'Widget on page'],
            'code'             => 'widget_on_page',
            'active'           => 1,
