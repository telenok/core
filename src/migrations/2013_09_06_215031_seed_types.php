        ...
        if (Schema::hasTable('object_type') && Schema::hasTable('object_field')) {
            DB::table('object_type')->insertGetId(
                [
                    ...
                    'code'             => 'object_type',
                    'active'           => 1,
                    'model_class'      => '\App\Vendor\Telenok\Core\Model\Object\Type',
            ...
            DB::table('object_type')->insertGetId(
                [
                    ...
                    'code'             => 'object_field',
                    'active'           => 1,
                    'model_class'      => '\App\Vendor\Telenok\Core\Model\Object\Field',
            ...
            DB::table('object_type')->insertGetId(
                [
                    ...
                    'active'           => 1,
                    'model_class'      => '\App\Vendor\Telenok\Core\Model\Object\Sequence',
                    'controller_class' => '\App\Vendor\Telenok\Core\Module\Objects\Sequence\Controller',
                ]
            );
            ...
            DB::table('object_type')->insertGetId(
                [
                    ...
                    'active'         => 1,
                    'has_versioning' => 1,
                    'model_class'    => '\App\Vendor\Telenok\Core\Model\User\User',
                ]
            );
            ...
            DB::table('object_type')->insertGetId(
                [
                    'id'          => DB::table('object_sequence')->insertGetId(['id' => null, 'model_class' => '\App\Vendor\Telenok\Core\Model\Object\Type']),
                    'title'       => json_encode(['ru' => 'Опция', 'en' => 'Option'], JSON_UNESCAPED_UNICODE),
                    'title_list'  => json_encode(['ru' => 'Опция', 'en' => 'Option'], JSON_UNESCAPED_UNICODE),
                    'code'        => 'option',
                    'active'      => 1,
                    'model_class' => '\App\Vendor\Telenok\Core\Model\System\Option',
                ]
            );
            ...
            DB::table('object_type')->insertGetId(
                [
                    ...
                    'code'             => 'object_version',
                    'active'           => 1,
                    'model_class'      => '\App\Vendor\Telenok\Core\Model\Object\Version',
            ...
            DB::table('object_type')->insertGetId(
                [
                    ...
                    'code'        => 'resource',
                    'active'      => 1,
                    'model_class' => '\App\Vendor\Telenok\Core\Model\Security\Resource',
                ]
            );
            ...
            DB::table('object_type')->insertGetId(
                [
                    'id'               => DB::table('object_sequence')->insertGetId(['id' => null, 'model_class' => '\App\Vendor\Telenok\Core\Model\Object\Type']),
                    'title'            => json_encode(['ru' => 'Конфигурация', 'en' => 'Configuration'], JSON_UNESCAPED_UNICODE),
                    'title_list'       => json_encode(['ru' => 'Конфигурация', 'en' => 'Configuration'], JSON_UNESCAPED_UNICODE),
                    'code'             => 'config',
                    'active'           => 1,
            ...
            DB::table('object_type')->insertGetId(
                [
                    ...
                    'code'        => 'role',
                    'active'      => 1,
                    'model_class' => '\App\Vendor\Telenok\Core\Model\Security\Role',
                ]
            );
            ...
            DB::table('object_type')->insertGetId(
                [
                    ...
                    'code'        => 'group',
                    'active'      => 1,
                    'model_class' => '\App\Vendor\Telenok\Core\Model\User\Group',
                ]
            );
            ...
            DB::table('object_type')->insertGetId(
                [
                    ...
                    'code'        => 'permission',
                    'active'      => 1,
                    'model_class' => '\App\Vendor\Telenok\Core\Model\Security\Permission',
                ]
            );
            ...
            DB::table('object_type')->insertGetId(
                [
                    ...
                    'active'      => 1,
                    'model_class' => '\App\Vendor\Telenok\Core\Model\Security\SubjectPermissionResource',
                ]
            );
            ...
            DB::table('object_type')->insertGetId(
                [
                    ...
                    'code'        => 'user_message',
                    'active'      => 1,
                    'model_class' => '\App\Vendor\Telenok\Core\Model\User\UserMessage',
                ]
            );
            ...
            DB::table('object_type')->insertGetId(
                [
                    ...
                    'code'             => 'widget_on_page',
                    'active'           => 1,
                    'model_class'      => '\App\Vendor\Telenok\Core\Model\Web\WidgetOnPage',
                    'controller_class' => '\App\Vendor\Telenok\Core\Module\Web\WidgetOnPage\Controller',
                ]
            );
