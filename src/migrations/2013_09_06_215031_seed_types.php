	...
	public function up()
	{
		if (Schema::hasTable('object_type') && Schema::hasTable('object_field'))
		{
			DB::table('object_type')->insertGetId(
					[
						'id' => DB::table('object_sequence')->insertGetId(['id' => null, 'class_model' => '\App\Telenok\Core\Model\Object\Type']),
						...
						'code' => 'object_type',
						'active' => 1,
						'class_model' => '\App\Telenok\Core\Model\Object\Type',
						'class_controller' => '\App\Telenok\Core\Module\Objects\Type\Controller',
						'treeable' => 1,
					]
			);
			...
			DB::table('object_type')->insertGetId(
					[
						...
						'code' => 'object_field',
						'active' => 1,
						'class_model' => '\App\Telenok\Core\Model\Object\Field',
						'class_controller' => '\App\Telenok\Core\Module\Objects\Field\Controller',
					]
			);
			...
			DB::table('object_type')->insertGetId(
					[
						...
						'active' => 1,
						'class_model' => '\App\Telenok\Core\Model\Object\Sequence',
						'class_controller' => '\App\Telenok\Core\Module\Objects\Sequence\Controller',
					]
			);
			...
			DB::table('object_type')->insertGetId(
					[
						...
						'code' => 'object_tab',
						'active' => 1,
						'class_model' => '\App\Telenok\Core\Model\Object\Tab'
					]
			);
			...
			DB::table('object_type')->insertGetId(
					[
						...
						'code' => 'user',
						'active' => 1,
						'class_model' => '\App\Telenok\Core\Model\User\User',
					]
			);
			...
			DB::table('object_type')->insertGetId(
					[
						...
						'code' => 'object_version',
						'active' => 1,
						'class_model' => '\App\Telenok\Core\Model\Object\Version',
						'class_controller' => '\App\Telenok\Core\Module\Objects\Version\Controller',
					]
			);
			...
			DB::table('object_type')->insertGetId(
					[
						...
						'code' => 'resource',
						'active' => 1,
						'class_model' => '\App\Telenok\Core\Model\Security\Resource',
					]
			);
			...
			DB::table('object_type')->insertGetId(
					[
						...
						'code' => 'setting',
						'active' => 1,
						'class_model' => '\App\Telenok\Core\Model\System\Setting',
						'class_controller' => '\App\Telenok\Core\Module\System\Setting\Controller',
					]
			);
			...
			DB::table('object_type')->insertGetId(
					[
						...
						'code' => 'role',
						'active' => 1,
						'class_model' => '\App\Telenok\Core\Model\Security\Role',
					]
			);
			...
			DB::table('object_type')->insertGetId(
					[
						...
						'code' => 'group',
						'active' => 1,
						'class_model' => '\App\Telenok\Core\Model\User\Group',
					]
			);
			...
			DB::table('object_type')->insertGetId(
					[
						...
						'code' => 'permission',
						'active' => 1,
						'class_model' => '\App\Telenok\Core\Model\Security\Permission',
					]
			);
			...
			DB::table('object_type')->insertGetId(
					[
						...
						'active' => 1,
						'class_model' => '\App\Telenok\Core\Model\Security\SubjectPermissionResource',
					]
			);
			...
			DB::table('object_type')->insertGetId(
					[
						...
						'code' => 'user_message',
						'active' => 1,
						'class_model' => '\App\Telenok\Core\Model\User\UserMessage',
					]
			);
			...
			DB::table('object_type')->insertGetId(
					[
						...
						'code' => 'language',
						'active' => 1,
						'class_model' => '\App\Telenok\Core\Model\System\Language',
					]
			);
			...
			DB::table('object_type')->insertGetId(
					[
						...
						'code' => 'folder',
						'active' => 1,
						'class_model' => '\App\Telenok\Core\Model\System\Folder',
						'treeable' => 1
					]
			);
			...
			DB::table('object_type')->insertGetId(
					[
						...
						'code' => 'page',
						'active' => 1,
						'class_model' => '\App\Telenok\Core\Model\Web\Page',
						'class_controller' => '\App\Telenok\Core\Module\Web\Page\Controller',
						'treeable' => 1,
					]
			);
			...
			DB::table('object_type')->insertGetId(
					[
						...
						'code' => 'module_group',
						'active' => 1,
						'class_model' => '\App\Telenok\Core\Model\Web\ModuleGroup'
					]
			);
			...
			DB::table('object_type')->insertGetId(
					[
						...
						'code' => 'module',
						'active' => 1,
						'class_model' => '\App\Telenok\Core\Model\Web\Module'
					]
			);
			...
			DB::table('object_type')->insertGetId(
					[
						...
						'code' => 'widget_group',
						'active' => 1,
						'class_model' => '\App\Telenok\Core\Model\Web\WidgetGroup'
					]
			);
			...
			DB::table('object_type')->insertGetId(
					[
						...
						'code' => 'widget',
						'active' => 1,
						'class_model' => '\App\Telenok\Core\Model\Web\Widget'
					]
			);
			...
			DB::table('object_type')->insertGetId(
					[
						...
						'active' => 1,
						'class_model' => '\App\Telenok\Core\Model\Web\PageController',
						'class_controller' => '\App\Telenok\Core\Module\Web\PageController\Controller',
					]
			);
			...
			DB::table('object_type')->insertGetId(
					[
						...
						'code' => 'widget_on_page',
						'active' => 1,
						'class_model' => '\App\Telenok\Core\Model\Web\WidgetOnPage',
						'class_controller' => '\App\Telenok\Core\Module\Web\WidgetOnPage\Controller',
					]
			);
			...
			DB::table('object_type')->insertGetId(
					[
						...
						'code' => 'file_extension',
						'active' => 1,
						'class_model' => '\App\Telenok\Core\Model\File\FileExtension', 
					]
			);
			...
			DB::table('object_type')->insertGetId(
					[
						...
						'code' => 'file_mime_type',
						'active' => 1,
						'class_model' => '\App\Telenok\Core\Model\File\FileMimeType', 
					]
			);
			...
			DB::table('object_type')->insertGetId(
					[
						...
						'code' => 'file',
						'active' => 1,
						'class_model' => '\App\Telenok\Core\Model\File\File', 
					]
			);
			...
			DB::table('object_type')->insertGetId(
					[
						...
						'code' => 'file_category',
						'active' => 1,
						'class_model' => '\App\Telenok\Core\Model\File\FileCategory', 
					]
			);
			...
			DB::table('object_type')->insertGetId(
					[
						...
						'code' => 'domain',
						'active' => 1,
						'class_model' => '\App\Telenok\Core\Model\Web\Domain', 
						'class_controller' => '\App\Telenok\Core\Module\Web\Domain\Controller',
					]
			);
		}
	}
