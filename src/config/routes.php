<?php
    ...
    app('router')->get('telenok/module/web-page-constructor/view/page/remove/widget-id/{id}/', array('as' => 'telenok.module.web-page-constructor.view.page.remove.widget', 'uses' => 'App\Vendor\Telenok\Core\Module\Web\PageConstructor\Controller@removeWidget'));
