...
class SubjectPermissionResource extends \App\Vendor\Telenok\Core\Abstraction\Eloquent\Object\Model {
    ...
    {
        return $this->belongsTo('\App\Vendor\Telenok\Core\Model\Security\Permission', 'acl_permission_object_sequence');
    }

    public function aclResourceObjectSequence()
    {
        return $this->belongsTo('\App\Vendor\Telenok\Core\Model\Object\Sequence', 'acl_resource_object_sequence');
    }

    public function aclSubjectObjectSequence()
    {
        return $this->belongsTo('\App\Vendor\Telenok\Core\Model\Object\Sequence', 'acl_subject_object_sequence');
    }
