...
class Controller extends \Telenok\Core\Interfaces\Field\Relation\Controller {
    ...
    public function getFilterQuery($field = null, $model = null, $query = null, $name = null, $value = null) 
    {
		if (!empty($value))
		{
			if ($field->morph_one_to_many_has)
			{
				...
				$linkedTable = \App\Telenok\Core\Model\Object\Sequence::getModel($field->morph_one_to_many_has)->code;
    ...
    public function saveModelField($field, $model, $input)
    {
		...
		else if ($field->morph_one_to_many_has && app('auth')->can('update', 'object_field.' . $model->getTable() . '.' . $field->code))
		{ 
    ...
    public function postProcess($model, $type, $input)
    {
        try 
        {
            ...
            $typeBelongTo = \App\Telenok\Core\Model\Object\Type::findOrFail($input->get('morph_one_to_many_has')); 
