<?php namespace Telenok\Core\Abstraction\Setting;

/**
 * @class Telenok.Core.Abstraction.Setting.Controller
...
abstract class Controller extends \Telenok\Core\Abstraction\Controller\Controller {
     ...
     * @member Telenok.Core.Abstraction.Setting.Controller
     */	
    ...
    {
        return app('\App\Vendor\Telenok\Core\Support\Validator\Setting')
                        ->setRuleList($rule)
                        ->setInput($input)
                        ->setMessage($message)
